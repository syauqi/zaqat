                            ...
                            <table class="display" id="auto-fill">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('distribusi_zakat.show', $item->id)}}" class="btn btn-success px-2">
                                            ...
                                            <a href="{{route('distribusi_zakat.edit', $item->id)}}" class="btn btn-info px-2">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <form action="{{route('distribusi_zakat.destroy', $item->id)}}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('delete')
